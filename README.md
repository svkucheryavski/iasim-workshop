...
This repository contains learning materials for Workshop 1 at [IASIM-2024](https://2024.iasim.net), which will take place (or already have taken) in Bilbao in July 2024. If you signed up for the workshop, please read this document carefully and follow the student's guidelines.
...
The list and a short description of the course activities (classes) is given below.
